...
// //       data: [
// //         {
// //           _id: "688d9741997199e2341ed4c1",
// //           userId: "6875467f79fdf212f3e2a002",
// //           billingAddress: {
// //             fullName: "abhinesh",
// //             phone: "7458956915",
// //             addressLine1: "A-41, FIEE Complex Okhla Phase-2, New Delhi 110020",
// //             city: "new delhi",
// //             state: "delhi",
// //             postalCode: "110020",
// //             country: "India"
...
// //           createdAt: "2025-08-02T04:42:41.266Z",
// //           updatedAt: "2025-08-02T04:42:46.543Z"
// //         }
// //       ]
// //     };
// //   }
...
//       console.log('Orders fetched successfully ORDER DATA admin============>:', response.data);
//     } catch (err) {
//       setError(err);
...
//         'preparing': 'bg-orange-100 text-orange-800',
//         'cancelled': 'bg-red-100 text-red-800',
//         'shipment_failed': 'bg-red-100 text-red-800'
//       },
//       order: {
//         'completed': 'bg-green-100 text-green-800',
//         'processing': 'bg-blue-100 text-blue-800',
...
//   const generateBillPDF = (order) => {
//     const firstItem = order.cartItems && order.cartItems[0];
//     const subtotal = firstItem ? firstItem.price * firstItem.quantity : order.totalAmount;
//     const tax = 0; // You may need to calculate this based on your business logic
//     const shippingFee = 0; // You may need to calculate this based on your business logic
...
//             body { font-family: Arial, sans-serif; margin: 0; padding: 20px; line-height: 1.6; }
//             .header { text-align: center; margin-bottom: 30px; border-bottom: 2px solid #333; padding-bottom: 20px; }
//             .company-name { font-size: 28px; font-weight: bold; color: black; margin-bottom: 5px; }
//             .invoice-title { font-size: 24px; color: #333; margin-top: 10px; }
//             .invoice-info { display: flex; justify-content: space-between; margin-bottom: 30px; }
//             .billing-info { width: 48%; }
//             .section-title { font-size: 16px; font-weight: bold; color: #333; margin-bottom: 10px; border-bottom: 1px solid #ddd; padding-bottom: 5px; }
...
//           <div class="header">
//             <div class="logo"  >
//               <img style="width: 70px; height: 70px;" src="/images/logo/cmklogo2.png" alt="Cureayurvedic Logo" />
//             </div>
//             <div class="company-name">Cureayurvedic</div>
//             <div>A-41, FIEE Complex Okhla Phase-2, New Delhi 110020</div>
//             <div>Phone: +91 8800023120 | Email: contact@cureayurvedic.com</div>
//             <div class="invoice-title">INVOICE</div>
//           </div>
...
//             <div class="billing-info">
//               <div class="section-title">Bill To:</div>
//               <div class="info-row"><strong>${order.billingAddress?.fullName || 'N/A'}</strong></div>
//               <div class="info-row">${order.billingAddress?.phone || 'N/A'}</div>
//               <div class="info-row">${order.billingAddress?.addressLine1 || 'N/A'}</div>
//               <div class="info-row">${order.billingAddress?.city || ''}, ${order.billingAddress?.state || ''} ${order.billingAddress?.postalCode || ''}</div>
//             </div>
//             <div class="billing-info">
//               <div class="section-title">Invoice Details:</div>
//               <div class="info-row">
//                 <span class="label">Invoice:</span> ${order._id}
//               </div>
//               <div class="info-row">
//                 <span class="label">Date:</span> ${new Date(order.createdAt).toLocaleDateString()}
//               </div>
//               <div class="info-row">
//                 <span class="label">User ID:</span> ${order.user}
//               </div>
//               <div class="info-row">
//                 <span class="label">Status:</span> 
//                 <span class="status-badge status-${order.paymentStatus?.toLowerCase()}">${order.paymentStatus}</span>
...
//     const userName = order.billingAddress?.fullName || '';
//     const phone = order.billingAddress?.phone || '';
...
//             <div>
//               <label className="block text-sm font-medium text-gray-700 mb-1">User Name</label>
//               <p className="text-gray-900">{order.billingAddress?.fullName || 'N/A'}</p>
//             </div>
//             <div>
//               <label className="block text-sm font-medium text-gray-700 mb-1">Phone</label>
//               <p className="text-gray-900">{order.billingAddress?.phone || 'N/A'}</p>
//             </div>
//             <div>
//               <label className="block text-sm font-medium text-gray-700 mb-1">Order Items</label>
//               <div className="text-gray-900">
//                 {order.cartItems?.map((item, index) => (
//                   <div key={index}>{item.productName} (Qty: {item.quantity})</div>
//                 )) || 'N/A'}
//               </div>
//             </div>
//             <div>
...
//               <p className="text-gray-900">{order.paymentMethod?.toUpperCase() || 'N/A'}</p>
//             </div>
//             <div>
//               <label className="block text-sm font-medium text-gray-700 mb-1">Order Status</label>
//               <span className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(order.orderStatus, 'order')}`}>
...
//                 {order.billingAddress?.addressLine1}, {order.billingAddress?.city}, {order.billingAddress?.state} {order.billingAddress?.postalCode}
//               </p>
//             </div>
//             <div className="md:col-span-2">
...
//                   <img style={{ width: '70px', height: '70px' }} src="/images/logo/cmklogo2.png" alt="Cureayurvedic Logo" />
//                 </div>
//                 <h3 className="text-xl font-bold text-blue-600">Cureayurvedic </h3>
//                 <p className="text-sm text-gray-600">A-41, FIEE Complex Okhla Phase-2, New Delhi 110020</p>
//                 <p className="text-sm text-gray-600">Phone: +91 8800023120 | Email: contact@cureayurvedic.com</p>
//                 <h4 className="text-lg font-semibold mt-4">INVOICE</h4>
//               </div>
...
//                 <div>
//                   <h5 className="font-semibold text-gray-700 mb-2">Bill To:</h5>
//                   <p className="text-sm">{order.billingAddress?.fullName || 'N/A'}</p>
//                   <p className="text-sm">{order.billingAddress?.phone || 'N/A'}</p>
//                   <p className="text-sm">{order.billingAddress?.addressLine1}</p>
//                 </div>
//                 <div>
//                   <h5 className="font-semibold text-gray-700 mb-2">Invoice Details:</h5>
//                   <p className="text-sm">Invoice: {order._id}</p>
...
//                     {order.cartItems?.map((item, index) => (
//                       <tr key={index}>
//                         <td className="py-2 text-black">{item.productName}</td>
//                         <td className="text-right text-black py-2">{item.quantity}</td>
//                         <td className="text-right text-black py-2">₹{item.price.toFixed(2)}</td>
//                         <td className="text-right text-black py-2">₹{(item.price * item.quantity).toFixed(2)}</td>
//                       </tr>
//                     )) || (
//                       <tr>
//                         <td className="py-2 text-black">Order Items</td>
//                         <td className="text-right text-black py-2">1</td>
//                         <td className="text-right text-black py-2">₹{order.totalAmount.toFixed(2)}</td>
//                         <td className="text-right text-black py-2">₹{order.totalAmount.toFixed(2)}</td>
//                       </tr>
//                     )}
//                   </tbody>
...
//                   <td className="px-6 py-4 whitespace-nowrap">
//                     <div>
//                       <div className="text-sm font-medium text-gray-900">{order.billingAddress?.fullName || 'N/A'}</div>
//                       <div className="text-sm text-gray-500">{order.billingAddress?.phone || 'N/A'}</div>
//                       <div className="text-xs text-gray-400">{order.userId}</div>
//                     </div>
//                   </td>
//                   <td className="px-6 py-4 whitespace-nowrap">
...
//                         {order.cartItems?.map(item => item.productName).join(', ') || 'N/A'}
//                       </div>
//                     </div>
//                   </td>
//                   <td className="px-6 py-4 whitespace-nowrap">
...
//               <div className="flex justify-between items-start mb-3">
//                 <div>
//                   <h3 className="text-lg font-semibold text-gray-900">{order.billingAddress?.fullName || 'N/A'}</h3>
//                   <p className="text-sm text-gray-500">{order.billingAddress?.phone || 'N/A'}</p>
//                   <p className="text-xs text-gray-400">{order.userId}</p>
//                 </div>
//                 <div className="flex gap-2">
//                   <button
        ...
        <body>
          ...
          <div class="invoice-info">
            ...
            <div class="billing-info">
              ...
              <div class="info-row">
                <span class="label">User ID:</span> ${order.userId || order.user || 'N/A'}
              </div>
              <div class="info-row">
                <span class="label">Status:</span> 
                <span class="status-badge status-${order.paymentStatus?.toLowerCase()}">${order.paymentStatus}</span>
      ...
      <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">User ID</label>
              <p className="text-gray-900">{order.userId || order.user || 'N/A'}</p>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Order ID</label>
              <p className="text-gray-900">{order._id}</p>
            ...
            <div className="border border-gray-200 rounded-lg p-6 mb-6">
              ...
              <div className="grid grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm">Invoice: {order._id}</p>
                  <p className="text-sm">Date: {new Date(order.createdAt).toLocaleDateString()}</p>
                  <p className="text-sm">User ID: {order.userId || order.user || 'N/A'}</p>
                </div>
              </div>
                ...
                <tr key={order._id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
                      <div className="text-sm font-medium text-gray-900">{order.billingAddress?.fullName || 'N/A'}</div>
                      <div className="text-sm text-gray-500">{order.billingAddress?.phone || 'N/A'}</div>
                      <div className="text-xs text-gray-400">{order.userId || order.user || 'N/A'}</div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
            ...
            <div key={order._id} className="border-b border-gray-200 p-4">
              <div className="flex justify-between items-start mb-3">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">{order.billingAddress?.fullName || 'N/A'}</h3>
                  <p className="text-sm text-gray-500">{order.billingAddress?.phone || 'N/A'}</p>
                  <p className="text-xs text-gray-400">{order.userId || order.user || 'N/A'}</p>
                </div>
                <div className="flex gap-2">
                  <button
                    onClick={() => setSelectedOrder(order)}
